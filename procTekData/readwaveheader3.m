function x = readwaveheader3(fid)
  x.settype=fread(fid,1,'int32');
  x.wfmcnt=fread(fid,1,'uint32');
  x.acquisition_counter=fread(fid,1,'uint64');
  x.transaction_counter=fread(fid,1,'uint64');
  x.slot_id=fread(fid,1,'int32');
  x.is_static_flag=fread(fid,1,'int32');
  x.wfm_update_specification_count=fread(fid,1,'uint32');
  x.imp_dim_ref_count=fread(fid,1,'uint32');
  x.exp_dim_ref_count=fread(fid,1,'uint32');
  x.data_type=fread(fid,1,'int32');
  x.gen_purpose_counter=fread(fid,1,'uint64');
  x.accumulated_waveform_count=fread(fid,1,'uint32');
  x.target_accumulation_count=fread(fid,1,'uint32');
  x.curve_ref_count=fread(fid,1,'uint32');
  x.number_of_requested_fast_frames=fread(fid,1,'uint32');
  x.number_of_acquired_fast_frames=fread(fid,1,'uint32');
  x.summary_frame_type=fread(fid,1,'uint16');
  x.pix_map_display_format=fread(fid,1,'int32');
  ...
  x.exp_dim_1_dim_size=fread(fid,1,'uint32');
  ...
  x.exp_dim_1_format=fread(fid,1,'int32');
  x.exp_dim_1_storage_type=fread(fid,1,'int32');
  ...
  x.exp_dim_2_dim_size=fread(fid,1,'uint32');
  ...
  x.exp_dim_2_format=fread(fid,1,'int32');
  x.exp_dim_2_storage_type=fread(fid,1,'int32');
  ...
  x.imp_dim_1_dim_size=fread(fid,1,'uint32');
  ...
  x.imp_dim_1_spacing=fread(fid,1,'uint32');
  ...
  x.imp_dim_2_dim_size=fread(fid,1,'uint32');
  ...
  x.imp_dim_2_spacing=fread(fid,1,'uint32');
  ...
  x.time_base_1_real_point_spacing=fread(fid,1,'uint32');
  x.time_base_1_sweep=fread(fid,1,'int32');
  x.time_base_1_type_of_base=fread(fid,1,'int32');
  x.time_base_2_real_point_spacing=fread(fid,1,'uint32');
  x.time_base_2_sweep=fread(fid,1,'int32');
  x.time_base_2_type_of_base=fread(fid,1,'int32');
end
